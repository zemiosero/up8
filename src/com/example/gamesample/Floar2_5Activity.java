...
public class Floar2_5Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar2_5Activity.this, Floar2_4Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar2_5Activity.this, Floar2_1Activity.class);
