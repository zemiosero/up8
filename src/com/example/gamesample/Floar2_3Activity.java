...
public class Floar2_3Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar2_3Activity.this, Floar2_2Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar2_3Activity.this, Floar2_4Activity.class);
