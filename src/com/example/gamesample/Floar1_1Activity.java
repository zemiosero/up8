...
public class Floar1_1Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar1_1Activity.this, Floar1_5Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar1_1Activity.this, Floar1_2Activity.class);
	...
	public void imgClick(View v){
		Intent it =new Intent();
		it.setClass(Floar1_1Activity.this, Room1Activity.class);
