...
public class Floar5_4Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar5_4Activity.this, Floar5_3Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar5_4Activity.this, Floar5_5Activity.class);
