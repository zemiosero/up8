...
public class Floar5_1Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar5_1Activity.this, Floar5_5Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar5_1Activity.this, Floar5_2Activity.class);
	...
	public void imgClick(View v){
		Intent it =new Intent();
		it.setClass(Floar5_1Activity.this, Room1_1Activity.class);
