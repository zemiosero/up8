...
public class Floar2_1Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar2_1Activity.this, Floar2_5Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar2_1Activity.this, Floar2_2Activity.class);
	...
	public void imgClick(View v){
		Intent it =new Intent();
		it.setClass(Floar2_1Activity.this, Room1_1Activity.class);
