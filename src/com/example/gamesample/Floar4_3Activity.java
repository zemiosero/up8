...
public class Floar4_3Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar4_3Activity.this, Floar4_2Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar4_3Activity.this, Floar4_4Activity.class);
