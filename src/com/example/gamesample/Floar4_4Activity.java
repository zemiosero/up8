...
public class Floar4_4Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar4_4Activity.this, Floar4_3Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar4_4Activity.this, Floar4_5Activity.class);
