...
public class Floar4_5Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar4_5Activity.this, Floar4_4Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar4_5Activity.this, Floar4_1Activity.class);
