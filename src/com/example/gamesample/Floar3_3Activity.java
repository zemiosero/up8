...
public class Floar3_3Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar3_3Activity.this, Floar3_2Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar3_3Activity.this, Floar3_4Activity.class);
