...
public class Floar1_5Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar1_5Activity.this, Floar1_4Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar1_5Activity.this, Floar1_1Activity.class);
