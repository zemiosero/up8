...
public class Floar5_5Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar5_5Activity.this, Floar5_4Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar5_5Activity.this, Floar5_1Activity.class);
