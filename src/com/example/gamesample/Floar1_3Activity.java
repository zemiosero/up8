...
public class Floar1_3Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar1_3Activity.this, Floar1_2Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar1_3Activity.this, Floar1_4Activity.class);
