...
public class Floar1_4Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar1_4Activity.this, Floar1_3Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar1_4Activity.this, Floar1_5Activity.class);
