...
public class Floar3_4Activity extends Activity{
	...
	public void btnOnLeft(View v) {
		...
		it.setClass(Floar3_4Activity.this, Floar3_3Activity.class);
	...
	public void btnOnRight(View v){
		Intent it =new Intent();
		it.setClass(Floar3_4Activity.this, Floar3_5Activity.class);
